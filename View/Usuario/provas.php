<?php
    ...
    $result = mysqli_query(conectar(), "SELECT * FROM prova where completa = 1 ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
                                ...
                                <table class="table table-bordered data-table">
                                    ...
                                    <tbody>
                                        ...
                                        while ($res = mysqli_fetch_array($result)) {
                                            echo "<tr>";
                                            echo "<td>" . $res['nome'] . "</td>";
                                            echo "<td>" . $res['nota_corte'] . "</td>";
                                            echo "<td><a href=\"resolverProva.php?id=$res[id]\" class='btn btn-info'>Resolver</a></td>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
