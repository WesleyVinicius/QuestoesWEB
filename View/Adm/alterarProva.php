<?php
    ...
    include_once("../../Controller/ctrl_provaAlteracao.php");
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
        ...
        <div id="content">
            <div id="content-header">
                <div id="breadcrumb"> 
                    ...
                    <a href="listarProva.php" class="current">Listar Provas</a>
                    <a href="#" class="current">Alterar Prova</a>
                </div>
            </div>
                    ...
                    <div class="span12">
                        <div class="widget-box">
                            ...
                            <div class="widget-content">
                                <form action="../../Controller/ctrl_provaAlteracao.php" method="post" class="form-horizontal">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="listarProva.php" class='btn btn-danger'>Cancelar</a>
                                    </div>
                                </form>
                            </div>
                        </div>
