<?php
    ...
    $result = mysqli_query(conectar(), "SELECT * FROM instituicao ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
        ...
        <div id="content">
            <div id="content-header">
                <div id="breadcrumb"> 
                    ...
                    <a href="#" class="current">Listar Instituições</a>
                </div>
            </div>
            <p class="botao"><a href="cadastrarInstituicao.php" class='btn btn-info'>+ Cadastrar</a></p>
                                ...
                                <table class="table table-bordered data-table">
                                    ...
                                    <tbody>
                                            ...
                                            while ($res = mysqli_fetch_array($result)) {
                                                echo "<tr>";
                                                echo "<td>" . $res['nome'] . "</td>";
                                                echo "<td><a href=\"alterarInstituicao.php?id=$res[id]\" class='btn btn-success'>Alterar</a> "
                                                        . "<a href=\"../../Controller/ctrl_instituicao.php?id_exclusao=$res[id]\" class='btn btn-danger' onClick=\"return confirm('Tem certeza que deseja excluir essa instituiçao?')\">Excluir</a></td>";
                                                echo "</tr>";
                                            }
                                            ?>
                                    </tbody>
