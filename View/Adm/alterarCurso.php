<?php
    ...
    include_once("../../Controller/ctrl_cursoAlteracao.php");
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
        ...
        <div id="content">
            <div id="content-header">
                <div id="breadcrumb"> 
                    ...
                    <a href="listarCurso.php" class="current">Listar Cursos</a>
                    <a href="#" class="current">Alterar Curso</a>
                </div>
            </div>
                    ...
                    <div class="span12">
                        <div class="widget-box">
                            ...
                            <div class="widget-content">
                                <form action="../../Controller/ctrl_cursoAlteracao.php" method="post" class="form-horizontal">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="listarCurso.php" class='btn btn-danger'>Cancelar</a>
                                    </div>
                                </form>
                            </div>
                        </div>
