<?php
    ...
    include_once("../../Controller/ctrl_categoriaAlteracao.php");
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
        ...
        <div id="content">
            <div id="content-header">
                <div id="breadcrumb"> 
                    ...
                    <a href="listarCategoria.php" class="current">Listar Categorias</a>
                    <a href="#" class="current">Alterar Categoria</a>
                </div>
            </div>
                    ...
                    <div class="span12">
                        <div class="widget-box">
                            ...
                            <div class="widget-content">
                                <form action="../../Controller/ctrl_categoriaAlteracao.php" method="post" class="form-horizontal">
                                    <div class="control-group">
                                        <label class="control-label">Nome:</label>
                                        <div class="controls">
                                            <input type="text" class="span11" name="nome" placeholder="First name" value="<?php echo $nome; ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-actions">
                                        <input type="hidden" name="id" value=<?php echo $_GET['id']; ?>>
                                        <button type="submit" class="btn btn-success" name="update" vuale="Alterar">Alterar</button>
                                        <a href="listarCategoria.php" class='btn btn-danger'>Cancelar</a>
                                    </div>
                                </form>
                            </div>
                        </div>
