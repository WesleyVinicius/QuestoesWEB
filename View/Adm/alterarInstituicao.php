<?php
    ...
    include_once("../../Controller/ctrl_instituicaoAlteracao.php");
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
        ...
        <div id="content">
            <div id="content-header">
                <div id="breadcrumb"> 
                    ...
                    <a href="listarInstituicao.php" class="current">Listar Instituições</a>
                    <a href="#" class="current">Alterar Instituição</a>
                </div>
            </div>
                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                                <h5>Alterar Instituição</h5>
                            </div>
                            <div class="widget-content">
                                <form action="../../Controller/ctrl_instituicaoAlteracao.php" method="post" class="form-horizontal">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="listarInstituicao.php" class='btn btn-danger'>Cancelar</a>
                                    </div>
                                </form>
                            </div>
                        </div>
