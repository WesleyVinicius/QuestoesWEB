...
<html lang="pt-br">
    ...
    <body>
        ...
        <div id="content">
            <div id="content-header">
                <div id="breadcrumb"> 
                    ...
                    <a href="#" class="current">Listar Questões</a>
                </div>
            </div>
            <p class="botao"><a href="cadastrarQuestao.php" class='btn btn-info'>+ Cadastrar</a></p>
                                ...
                                <table class="table table-bordered data-table">
                                    ...
                                    <tbody>
                                        ...
                                        while ($res = mysqli_fetch_array($result)) {
                                            ...
                                            echo "<td><a href=\"alterarQuestao.php?id=$res[id]\" class='btn btn-success'>Alterar</a></td>";
                                            echo "<td><a href=\"../../Controller/ctrl_questao.php?id_exclusao=$res[id]\" class='btn btn-danger' onClick=\"return confirm('Tem certeza que deseja excluir essa instituiçao?')\">Excluir</a></td>";
        ...
        <script src="../Estilo/js/maruti.tables.js"></script>
    </body>
</html>