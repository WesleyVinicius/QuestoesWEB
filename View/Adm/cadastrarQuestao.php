...
$result = mysqli_query(conectar(), "SELECT * FROM questao ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
        ...
        <div id="content">
            <div id="content-header">
                <div id="breadcrumb"> 
                    ...
                    <a href="#" class="current">Cadastrar Questão</a>
                </div>
            </div>
            <div class="tabela">
                        ...
                        <div class="span11">
                            <div class="widget-box">
                                ...
                                <div class="widget-content">
                                    <form action="../../Controller/ctrl_questao.php" method="post" class="form-horizontal">
                                        <div class="control-group">
                                            <label class="control-label">Descrição</label>
                                            <div class="controls">
                                                <textarea class="span11" required name="descricao" placeholder="Descrição"
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea class="span11" name="texto_associado" placeholder="Texto"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span11" required name="alternativa_a" placeholder="Alternativa A"
                                                        oninvalid="setCustomValidity('Campo obrigatório')" 
                                                        onchange="try{setCustomValidity('')}catch(e){}"/>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span11" required name="alternativa_b" placeholder="Alternativa B"
                                                       oninvalid="setCustomValidity('Campo obrigatório')" 
                                                        onchange="try{setCustomValidity('')}catch(e){}"/>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span11" required name="alternativa_c" placeholder="Alternativa C"
                                                       oninvalid="setCustomValidity('Campo obrigatório')" 
                                                        onchange="try{setCustomValidity('')}catch(e){}"/>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span11" required name="alternativa_d" placeholder="Alternativa D"
                                                       oninvalid="setCustomValidity('Campo obrigatório')" 
                                                        onchange="try{setCustomValidity('')}catch(e){}"/>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span11" name="alternativa_e" placeholder="Alternativa E"/>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Alternativa Correta:</label>
                                            <div class="controls">
                                                <input type="text" class="span11" required name="alternativa_correta" placeholder="Alternativa Correta"
                                                       oninvalid="setCustomValidity('Campo obrigatório')" 
                                                        onchange="try{setCustomValidity('')}catch(e){}"/>
                                            </div>
                                        </div>
