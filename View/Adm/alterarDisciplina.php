<?php
    ...
    include_once("../../Controller/ctrl_disciplinaAlteracao.php");
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
        ...
        <div id="content">
            <div id="content-header">
                <div id="breadcrumb"> 
                    ...
                    <a href="listarDisciplina.php" class="current">Listar Disciplinas</a>
                    <a href="#" class="current">Alterar Disciplina</a>
                </div>
            </div>
                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                                <h5>Alterar Disciplina</h5>
                            </div>
                            <div class="widget-content">
                                <form action="../../Controller/ctrl_disciplinaAlteracao.php" method="post" class="form-horizontal">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="listarDisciplina.php" class='btn btn-danger'>Cancelar</a>
                                    </div>
                                </form>
                            </div>
                        </div>
