<?php
    ...
    $result = mysqli_query(conectar(), "SELECT * FROM prova ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
        ...
        <div id="content">
            <div id="content-header">
                <div id="breadcrumb"> 
                    ...
                    <a href="#" class="current">Listar Provas</a>
                </div>
            </div>
            <p class="botao">
                <a href="cadastrarProva.php" class='btn btn-info'>+ Cadastrar Prova</a>
                <a href="cadastrarQuestao.php" class='btn btn-info'>+ Cadastrar Questão</a>
            </p>
                                ...
                                <table class="table table-bordered data-table">
                                    ...
                                    <tbody>
                                        ...
                                        while ($res = mysqli_fetch_array($result)) {
                                            echo "<tr>";
                                            echo "<td>" . $res['nome'] . "</td>";
                                            echo "<td><a href=\"alterarProva.php?id=$res[id]\" class='btn btn-success'>Alterar</a> "
                                                        . "<a href=\"../../Controller/ctrl_prova.php?id_exclusao=$res[id]\" class='btn btn-danger' onClick=\"return confirm('Tem certeza que deseja excluir essa instituiçao?')\">Excluir</a></td>";
