        ...
        <div id="content">
            <div id="content-header">
                <div id="breadcrumb"> 
                    ...
                    <a href="#" class="current">Cadastrar Prova</a>
                </div>
            </div>
                    ...
                    <div class="span12">
                        <div class="widget-box">
                            ...
                            <div class="widget-content">
                                <form action="../../Controller/ctrl_prova.php" method="post" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">Nota de corte:</label>
                                        <div class="controls">
                                            <input type="number" class="span11" name="nota_corte" placeholder="Nota de corte"
                                                   />
                                        </div>
                                    </div>
